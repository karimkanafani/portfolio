...
export default function Project({title, description, tags, imageUrl}: ProjectProps) {
    ...
    return (
        <motion.div ref={ref} style={{
            ...
            <section  className="bg-gray-100 max-w-[42rem] border border-black/5 rounded-lg overflow-hidden sm:pr-8 relative sm:h-[22rem] group-even:pl-8 hover:bg-gray-200 transition">
